...
from
    dblink ('broker_server', 'select
        ...
        compile_fpds_business_categories(pafa.small_business_competitive, pafa.for_profit_organization, pafa.alaskan_native_owned_corpo, pafa.american_indian_owned_busi, pafa.asian_pacific_american_own, pafa.black_american_owned_busin, pafa.hispanic_american_owned_bu, pafa.native_american_owned_busi, pafa.native_hawaiian_owned_busi, pafa.subcontinent_asian_asian_i, pafa.tribally_owned_business, pafa.other_minority_owned_busin, pafa.minority_owned_business, pafa.women_owned_small_business, pafa.economically_disadvantaged, pafa.joint_venture_women_owned, pafa.joint_venture_economically, pafa.woman_owned_business, pafa.service_disabled_veteran_o, pafa.veteran_owned_business, pafa.c8a_program_participant, pafa.the_ability_one_program, pafa.dot_certified_disadvantage, pafa.emerging_small_business, pafa.federally_funded_research, pafa.historically_underutilized, pafa.labor_surplus_area_firm, pafa.sba_certified_8_a_joint_ve, pafa.self_certified_small_disad, pafa.small_agricultural_coopera, pafa.small_disadvantaged_busine, pafa.community_developed_corpor, pafa.domestic_or_foreign_entity, pafa.foreign_owned_and_located, pafa.foreign_government, pafa.international_organization, pafa.foundation, pafa.community_development_corp, pafa.nonprofit_organization, pafa.other_not_for_profit_organ, pafa.state_controlled_instituti, pafa.c1862_land_grant_college, pafa.c1890_land_grant_college, pafa.c1994_land_grant_college, pafa.private_university_or_coll, pafa.minority_institution, pafa.historically_black_college, pafa.tribal_college, pafa.alaskan_native_servicing_i, pafa.native_hawaiian_servicing, pafa.hispanic_servicing_institu, pafa.us_federal_government, pafa.federal_agency, pafa.us_government_entity, pafa.interstate_entity, pafa.us_state_government, pafa.council_of_governments, pafa.city_local_government, pafa.county_local_government, pafa.inter_municipal_local_gove, pafa.municipality_local_governm, pafa.township_local_government, pafa.us_local_government, pafa.local_government_owned, pafa.school_district_local_gove, pafa.us_tribal_government, pafa.indian_tribe_federally_rec, pafa.housing_authorities_public, pafa.airport_authority, pafa.port_authority, pafa.transit_authority, pafa.planning_commission) as business_categories,
